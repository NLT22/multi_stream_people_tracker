...
Tập dữ liệu YOLO gốc của MMPTrack được sinh bằng cách \textit{chiếu} hộp 3D của mỗi người vào mọi camera, nên đánh nhãn cả những người bị che khuất hoàn toàn sau kệ hàng/tường (``phantom annotations'') --- những hộp này nằm trên nền (kệ hàng) và dạy detector ``nền = người'', sinh ra vô số phát hiện ma. Ngoài ra tập gốc không có ảnh nền (negative), càng làm detector dễ phát hiện nhầm. Môi trường retail bị nặng nhất do mật độ kệ hàng cao.

Để làm sạch, một mạng COCO YOLO11x độc lập (lớn hơn và mạnh hơn YOLO11n, pretrain trên COCO) được dùng làm ``bộ xác nhận'' (verifier): mỗi nhãn train chỉ được giữ lại khi bộ xác nhận cũng phát hiện được một người \textit{thực sự nhìn thấy được} chồng lắp với nhãn đó (IoU $>$ ngưỡng). Vì việc làm sạch quá mạnh trên \textit{mọi} môi trường lại loại nhầm cả người bị che khuất một phần nhưng có thật (làm giảm recall ở lobby/office), quy trình cuối cùng \textbf{chỉ áp dụng cho môi trường retail} --- nơi phantom là vấn đề thực --- và giữ nguyên nhãn các môi trường còn lại. Cách làm này loại bỏ $\sim$42\% nhãn retail (chủ yếu là hộp ma trên kệ và hộp bị che khuất hoàn toàn).

Detector được huấn luyện lại trên tập nhãn lai này (retail sạch + các môi trường khác giữ nguyên). Kết quả: precision phát hiện người trên 20 camera tăng từ 0{,}62 lên 0{,}94, MOTA trung bình per-camera tăng từ 0{,}64 lên 0{,}77, số lần chuyển định danh (ID switch) giảm gần một nửa, và Global IDF1 retail tăng 4,5 điểm phần trăm --- trong khi recall ở các môi trường không-retail được bảo toàn.
...
Đáng chú ý, kết quả toàn tập (0,798) là đánh giá trung thực trên đầy đủ 24 cảnh, thay vì 5 cảnh đại diện (mỗi môi trường 1 cảnh) như báo cáo sơ bộ trước đây. Mức chênh giữa các cảnh trong cùng môi trường là đáng kể: ví dụ retail\_3 (0,721) dễ hơn nhiều so với retail\_1 (0,597, cảnh khó nhất toàn tập).
...
\textbf{Lobby (0,906, 4 cảnh):} Môi trường đạt kết quả cao nhất. Người di chuyển theo lối đi rõ ràng, camera được đặt ở góc tốt, và trang phục người dùng đa dạng giúp phân biệt. Kết quả ổn định qua cả 4 cảnh (0,886--0,919).

\textbf{Office (0,880, 3 cảnh):} Kết quả cao và đồng đều (0,861--0,900). Môi trường văn phòng có điều kiện ánh sáng tốt, mật độ người thấp, và người dùng có trang phục văn phòng đủ đa dạng để phân biệt.

\textbf{Industry (0,847, 5 cảnh):} Kết quả đạt ngưỡng mục tiêu, vượt kỳ vọng ban đầu. Thách thức chính là đồng phục lao động làm mô hình ReID khó phân biệt, nhưng Buffered ID với cửa sổ 20 giây giúp tích lũy đủ bằng chứng để gán đúng định danh. Biến thiên giữa các cảnh lớn hơn (0,746--0,895), cho thấy một số cảnh industry có điều kiện khó hơn.

\textbf{Café (0,839, 4 cảnh):} Kết quả tốt nhưng có biến thiên đáng kể giữa các cảnh (0,733--0,931). Cảnh café\_3 (0,733) có IDF1 thấp hơn, nhiều khả năng do góc camera hoặc mật độ người khác với các cảnh còn lại.

\textbf{Retail (0,661, 8 cảnh):} Môi trường yếu nhất với biến thiên cao (0,597--0,721), nhưng đã cải thiện rõ rệt nhờ detector huấn luyện lại trên nhãn sạch (so với 0,616 của detector cũ). Nguyên nhân còn lại khiến retail thấp hơn các môi trường khác: (1) kệ hàng cao gây che khuất, làm detector bỏ sót nhiều người thực sự (recall retail giảm) --- đây là giới hạn vật lý không khắc phục được bằng thuật toán; (2) nhãn YOLO gốc của retail có $\sim$42\% là phantom/bị che khuất, phản ánh mức độ che khuất nghiêm trọng; (3) với 6 camera/cảnh (nhiều hơn các môi trường khác), không gian bán lẻ phức tạp và camera đặt gần góc khuất nhiều hơn. Retail\_1 (0,597) là cảnh khó nhất trong toàn tập val.
...
\begin{itemize}
    \item \textbf{Thông lượng:} $\sim$15 FPS/camera tại 20 camera đồng thời (preset reid0, \texttt{maxTargetsPerStream=40}), vượt mục tiêu 10 FPS/cam.
