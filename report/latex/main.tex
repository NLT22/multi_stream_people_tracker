...
Bảng~\ref{tab:results} trình bày kết quả Global IDF1 của hệ thống trên 5 môi trường kiểm thử. Kết quả so sánh hai chế độ: Buffered ID (chế độ production) và phương pháp baseline DMCT-Ext-TD \cite{Han2022}.

\begin{table}[H]
    \centering
    \caption[Kết quả Global IDF1 theo môi trường]{\bfseries\fontsize{12pt}{0pt}\selectfont Kết quả Global IDF1 theo môi trường}
    \begin{tabular}{|l|c|c|}
    \hline
    \bfseries Môi trường & \bfseries Hệ thống đề xuất & \bfseries Baseline \cite{Han2022} \\
    \hline
    Lobby   & 0,895 & --- \\
    Office  & 0,861 & --- \\
    Café    & 0,833 & --- \\
    ...
    Retail  & 0,660 & --- \\
    \hline
    \bfseries Trung bình & \bfseries 0,811 & \bfseries 0,741 \\
    \hline
    \end{tabular}
    \label{tab:results}
\end{table}

Hệ thống vượt cả hai mục tiêu đề ra: Global IDF1 trung bình 0,811 (vượt ngưỡng 0,8) và xử lý được 20 camera đồng thời ở tốc độ $\sim$10{,}6 FPS/camera (preset reid0, vượt ngưỡng 10 FPS). Điểm số trên baseline công bố trong \cite{Han2022} (0,741) tăng lên 0,811 --- tương đương cải thiện 9,4 điểm phần trăm.

Lưu ý: bảng baseline trong \cite{Han2022} không có phân tích per-scene chi tiết theo 5 môi trường; dấu ``---'' phản ánh việc không có dữ liệu so sánh trực tiếp per-environment.

\subsubsection{Phân tích theo môi trường}

\textbf{Lobby (0,895) và Office (0,861):} Hai môi trường này đạt kết quả cao nhất. Người di chuyển theo lối đi rõ ràng, camera được đặt ở góc tốt, và trang phục người dùng đa dạng giúp phân biệt.

\textbf{Café (0,833):} Kết quả tốt. Môi trường có ánh sáng tốt, mật độ người vừa phải, và camera bao phủ tốt các lối vào/ra.

\textbf{Industry (0,805):} Kết quả đạt ngưỡng mục tiêu. Thách thức chính là đồng phục lao động làm mô hình ReID khó phân biệt. Chế độ Buffered ID cải thiện đáng kể so với Live ID --- kết quả chi tiết trình bày ở Phần~\ref{sec:buffered_eval}.

\textbf{Retail (0,660):} Môi trường yếu nhất. Nguyên nhân chính: (1) kệ hàng cao gây che khuất, làm detector bỏ sót nhiều detection; (2) nhãn YOLO gốc có 39--40\% phantom annotations sau khi dọn sạch --- cho thấy có nhiều người thực sự bị che khuất hoàn toàn. Trần che khuất này là giới hạn vật lý của camera CCTV thông thường, không thể khắc phục hoàn toàn bằng cải thiện thuật toán.
