...
| Ảnh | Nội dung |
|---|---|
| `cam_{0..3}_occupancy.png` | Theo từng camera — mật độ hiện diện (vùng ở lâu). |
| `cam_{0..3}_footfall.png` | Theo từng camera — lưu lượng (số người khác nhau đi qua). |
| `cam_{0..3}_dwelltime.png` | Theo từng camera — thời gian dừng trung bình. |
| `bev_{occupancy,footfall,dwelltime}.png` | Ba bản đồ trên mặt sàn (gộp tất cả camera). |
