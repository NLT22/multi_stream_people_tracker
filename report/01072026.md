...
![RAG/Ask trên W022 – hỏi bằng ngôn ngữ tự nhiên](latex/Images/webui_ask_w022.png)

Hàm **tìm người từ ảnh** (giống MMP) cũng chạy trên W022: tải ảnh cắt → ứng viên `global_id` + dwell +
quỹ đạo BEV + lịch xuất hiện. Lưu ý: trên kho, độ tương đồng ngoại hình **rất thấp** (điểm ~7%, khớp
sai) — crop kho không tách được bằng ngoại hình, đúng lý do MTMC dùng liên kết **ưu tiên hình học** chứ
không dùng ngoại hình.

![W022 – tìm người từ ảnh (query → kết quả)](latex/Images/webui_ask_search_by_image_w022.png)
