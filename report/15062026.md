...
Thêm tầng **anchor-guided offline re-association** (§8, port từ AIC23 winner) **phá trần industry**: 0.29/0.39 → **0.68/0.75**, retail → **0.45**, không regression scene nào — bằng cách cụm (cluster) lại danh tính offline trên toàn clip, thay cho online greedy matching (gán ID ngay, không sửa lại được).
...
- **industry phá trần**: gần như gấp đôi/gấp ba (0.29→0.68, 0.39→0.75) — đây chính
...
- **Trần industry KHÔNG phải trần thật** — đó là giới hạn của **online greedy matching**. Tầng **anchor-guided offline** (§8) phá trần: industry 0.29/0.39 → **0.75/0.70**, retail → **0.45**, không regression scene nào.
