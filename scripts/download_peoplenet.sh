...
echo "  2. Use PeopleNet in any milestone with --nvinfer-config:"
echo "     python milestones/05_multi_stream_tracking.py \\"
echo "         --nvinfer-config configs/models/nvinfer_peoplenet.yml"
echo "  3. Milestones 04-08 infer PeopleNet's person class id from the label file."
