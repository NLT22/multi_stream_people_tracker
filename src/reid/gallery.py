...
class CrossCameraGalleryProbe(psm.BatchMetadataOperator):
    ...
    def _embedding_quality(self, row: dict,
        ...
        return quality.embedding_quality(
            row, rows,
            enabled=ENABLE_EMBEDDING_QUALITY_GATE,
            edge_margin_ratio=REID_EDGE_MARGIN_RATIO,
            min_height_ratio=REID_MIN_BBOX_HEIGHT_RATIO,
            min_area_ratio=REID_MIN_BBOX_AREA_RATIO,
            min_aspect=REID_MIN_BBOX_ASPECT_RATIO,
            max_aspect=REID_MAX_BBOX_ASPECT_RATIO,
            max_overlap_iou=REID_MAX_OVERLAP_IOU_FOR_UPDATE,
        )
